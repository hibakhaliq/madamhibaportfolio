...
const PopularClass = () => {
  ...
  return (
    <div className="container mx-auto md:h-screen py-10">
      ...
      <p className="text-3xl font-semibold  py-3">Our Most Popular Classes</p>
          ...
          return (
            ...
            <div className="flex justify-between py-2">
                <div className="flex gap-3">
                    <img src="/assets/h1.svg" alt="person" />
                    <div className="flex flex-col">
                        <p className="text-sm group-hover:text-white">Jimmy</p>
                        <p className="text-xs text-gray-500 group-hover:text-white">270 Enrolled</p>
                    </div>
                </div>
                <p className="text-xl text-purple-600 group-hover:text-white font-semibold">$12.95</p>
            </div>
            </div>
          );
        })}
